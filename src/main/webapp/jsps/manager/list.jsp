            ...
            <div class="form">
                <form action="#" method="post">
                    <table class="table table-hover table-bordered">
                        ...
                        <c:forEach  items="${list}"  var="manager"   varStatus="i">
                            <tr class="warning">
                                ...
                                <td align="center">${manager.mname}</td>
                                <td align="center">${manager.maccount}</td>
                                <td align="center">
                                    <a href="<%=request.getContextPath()%>/manager/addPage.action">添加</a>
                                    <a href="<%=request.getContextPath()%>/manager/editPage.action?id=${manager.mid}">修改</a>
                                    <a href="<%=request.getContextPath()%>/manager/delete.action?id=${manager.mid}">删除</a>
                                </td>
                            </tr>
                        </c:forEach>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-6 link">
                            <p class="text-center remove-margin"><small>用户管理?</small> <a href="<%=request.getContextPath()%>/manager/userManager.action" ><small>管理</small></a>
                            </p>
                        </div>
                    </div>
