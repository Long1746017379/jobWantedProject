                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <c:forEach  items="${list}"  var="user"   varStatus="i">
                            <tr class="warning">
                                ...
                                <td align="center">
                                    <a href="<%=request.getContextPath()%>/manager/addBlackList.action?id=${user.uid}">移入黑名单</a>
                                    <%--<a href="<%=request.getContextPath()%>/manager/outBlackList.action?id=${user.uid}">移出黑名单</a>--%>

                                <%--<c:forEach items="${blackList}" var="black" varStatus="k">
                                    <td align="center">
                                        <c:if test="${user.uid!=black.uid}">
                                            <a href="<%=request.getContextPath()%>/manager/addBlackList.action?id=${user.uid}">移入黑名单</a>
                                        </c:if>
