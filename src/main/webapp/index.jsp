		...
		<div class="login-box">
			...
			<form action="<%=request.getContextPath()%>/user/login.action" method="post" >
				<div class="form-group">
					<div class="col-xs-12  ">
						<div class="input-group">
							...
							<input type="text" id="uaccount" name="uaccount" class="form-control" placeholder="账号">
						</div>
					</div>
				</div>
				<div class="form-group">
					<div class="col-xs-12  ">
						<div class="input-group">
							...
							<input type="password" id="upassword" name="upassword" class="form-control" placeholder="密码">
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-xs-6 link">
						<p class="text-center remove-margin"><small>用户注册?</small> <a href="<%=request.getContextPath()%>/register.jsp" ><small>注册</small></a>
						</p>
					</div>
				</div>
